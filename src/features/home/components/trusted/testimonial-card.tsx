...
export function TestimonialCard({ testimonial }: TestimonialCardProps) {
  return (
    <article className="bg-panel flex shrink-0 basis-[88%] snap-start overflow-hidden rounded-xl sm:basis-[72%] lg:min-h-75 lg:basis-[calc((100%-1.5rem)/2)]">
      ...
      <blockquote className="flex flex-1 flex-col justify-center p-5 sm:p-6 lg:px-7 lg:py-8">
        <p className="text-ink leading-[1.55] font-normal md:text-[11px] lg:text-xl">
          {testimonial.quote}
        </p>

        <footer className="mt-4">
          <p className="text-ink font-bold md:text-[10.38px] lg:text-base">
            {testimonial.author}
          </p>
